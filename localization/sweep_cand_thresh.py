...
def main():
    ...
    for i, cpath in enumerate(ckpts):
        ...
        model = FishFormer(feat_dim=ckpt["feat_dim"], num_classes=NUM_CLASSES,
                           ...
                           drop=args.drop, drop_path=args.drop_path, n_levels=args.n_levels,
