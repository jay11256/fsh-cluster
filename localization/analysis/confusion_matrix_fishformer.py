...
from fishformer.data import FG_CLASSES, NUM_CLASSES, load_recording      # noqa: E402
from fishformer.train_former import predict_spans                        # noqa: E402
...
def main_multilabel():
    ...
    out_path = f"{ROOT}/fishformer_confusion_multilabel.json"
...
def plot_multilabel(json_path=None, out_path=None, cmap="Blues"):
    ...
    json_path = json_path or f"{ROOT}/fishformer_confusion_multilabel.json"
    out_path = out_path or f"{ROOT}/fishformer_confusion_multilabel.png"
...
def main():
    ...
    out_path = f"{ROOT}/fishformer_confusion.json"
    json.dump(out, open(out_path, "w"), indent=2)
...
def plot_sklearn_default(json_path=None, out_path=None):
    ...
    json_path = json_path or f"{ROOT}/fishformer_confusion.json"
    out_path = out_path or f"{ROOT}/fishformer_confusion_sklearn.png"
    d = json.load(open(json_path))
...
def plot_sklearn_blues_normalized(json_path=None, out_path=None):
    ...
    json_path = json_path or f"{ROOT}/fishformer_confusion.json"
    out_path = out_path or f"{ROOT}/fishformer_confusion_sklearn_blues.png"
    d = json.load(open(json_path))
    labels = d["columns"]
